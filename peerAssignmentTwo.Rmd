...
This simple map shows the lake name, with the size of the circle representing Sulphuric Acid levels. This pulls the most recent data from September 2017. A future version will be interactive, allowing the user to select different collection dates and chemicals.
```{r}
...
labels <- paste0(coordinates_and_data$popup, ", SO4 level = ", coordinates_and_data$SO4, ", Date ", coordinates_and_data$confirmedDate)
